...
class CourseSubjectController extends Controller
{
    ...
    public function store(StoreCourseSubjectRequest $request)
    {
        ...
        $request->session()->flash('message', 'Course subject has been added successfully.');
    ...
    public function update(UpdateCourseSubjectRequest $request, CourseSubject $courseSubject)
    {
        ...
        $request->session()->flash('message', 'Course subject has been updated successfully.');
    ...
    public function destroy(CourseSubject $courseSubject, Request $request)
    {
        ...
        $request->session()->flash('message', 'Course subject has been deleted successfully.');
