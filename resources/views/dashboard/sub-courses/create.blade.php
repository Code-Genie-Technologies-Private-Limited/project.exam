                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('sub-courses.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" id="name" type="text" name="name" placeholder="Enter Sub Course Name" length="160" autocomplete="sub-courses" autofocus required value="{{old('name')}}">
                                    @error('name')
