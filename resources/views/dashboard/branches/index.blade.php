                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="GET" action="{{ url()->current() }}">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control @error('branch_name') is-invalid @enderror"
                                            id="branch_name" type="text" name="branchname" placeholder="Enter branch..."
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control @error('branch_code') is-invalid @enderror"
                                            id="branch_code" type="text" name="branchcode" placeholder="Enter branch..."
                                            length="160" autocomplete="branch code" autofocus
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control @error('start_date') is-invalid @enderror"
                                            id="start_date" type="date" name="startdate" placeholder="Enter branch..."
                                            length="11" autocomplete="branch" autofocus
                                ...
                                {{-- <div class="form-group row">
                                    <label class="col-md-3 col-form-label" for="name">Branch</label>
                                    <div class="col-md-9">
                                ...
                                <tbody>
                                    @foreach ($branches as $branch)
                                        <tr class="{{ $branch->status == 0 ? 'table-danger' : '' }}">
                                            ...
                                            <td>{{ $branch->branch_name }}<span
                                                    class="badge badge-secondary">{{ $branch->blogs_count }}</span></td>
