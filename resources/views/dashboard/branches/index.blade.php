                        ...
                        <div class="card-body">
                            <form method="GET" action="{{ url()->current() }}">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control" id="branch_code" type="text" name="branchcode"
                                            placeholder="Enter branch_code ..." length="160"
                                            autocomplete="branch_code"focus value="{{ $filters['branchcode'] ?? '' }}">
                                        @error('branch_code')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control" id="branch_name" type="text" name="branchname"
                                            placeholder="Enter branch_name ..." length="160"
                                            autocomplete="branch_name"focus value="{{ $filters['branchname'] ?? '' }}">
                                        @error('branch_name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control" id="start_date" type="date" name="date"
                                            placeholder="Enter start_date ..." length="160" autocomplete="start_date"focus
                                            value="{{ $filters['date'] ?? '' }}">
                                        @error('start_date')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
