                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('branches.store') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control @error('branch_code') is-invalid @enderror"
                                            ...
                                            placeholder="Enter Branch code" length="160" autocomplete="branch_code" autofocus
                                            required value="{{ old('branch_code') }}">
                                        @error('branch_code')
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label" for="branch_name"> Branch Nmae</label>
                                    <div class="col-md-9">
                                        <input class="form-control @error('branch_name') is-invalid @enderror"
                                            id="branch_name" type="text" name="branch_name"
                                            placeholder="Enter Branch Name" length="160" autocomplete="subject" autofocus
                                            required value="{{ old('branch_name') }}">
                                        @error('branch_name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control @error('start_date') is-invalid @enderror"
                                            ...
                                            placeholder="Enter start date" length="160" autocomplete="start_date" autofocus
