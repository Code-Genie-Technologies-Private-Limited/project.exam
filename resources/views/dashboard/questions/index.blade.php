                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ url()->current() }}">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" id="name" type="text" name="name" placeholder="Enter question name" length="160" autocomplete="question" autofocus value="{{ $filters['name'] ?? '' }}">
                                    @error('name')
                        ...
                        <table class="table table-responsive-sm table-bordered table-striped table-sm mt-2">
                            ...
                            <tbody>
                                ...
                                <tr class="{{ $question->status == 0 ? 'table-danger' : '' }}">
                                    ...
                                    <td>{{ $question->name }}
                                        <a href="{{ route('questions.index', ['question' => $question->id]) }}">
                                    ...
                                    <td>
                                        <a href="{{ url('/questions/' . $question->id) . '?' . http_build_query(request()->query()) }}" class="btn btn-primary">View</a>
                                    </td>
                                    <td>
                                        <a href="{{ url('/questions/' . $question->id . '/edit') . '?' . http_build_query(request()->query()) }}" class="btn btn-primary">Edit</a>
                                    </td>
                                    <td>
