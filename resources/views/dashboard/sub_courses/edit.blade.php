                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('/sub-courses/' . $subCourse->id) . '?' . http_build_query($filters) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" id="name" type="text" name="name" placeholder="Enter subcourse..." autocomplete="Sub Course" autofocus required value="{{ old('name') ?? $subCourse->name }}">
                                    @error('name')
