            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST"
                                action="{{ url('/blogs/' . $blog->id) . '?' . http_build_query($filters) }}">
                                @csrf
                                @method('PUT')
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control" id="title" type="text" name="title"
                                            placeholder="Enter Subject Name" autocomplete="blog" autofocus required
                                ...
                                <a href="{{ url('/blogs?' . http_build_query($filters)) }}"
