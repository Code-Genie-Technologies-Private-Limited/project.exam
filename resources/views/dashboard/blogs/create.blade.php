                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('blogs.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control @error('name') is-invalid @enderror" id="name" type="text" name="title" placeholder="Enter Blog Name" length="160" autocomplete="blog" autofocus required value="{{ old('name') }}">
                                    @error('name')
