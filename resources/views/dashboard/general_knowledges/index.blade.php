                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <i class="fa fa-align-left"></i><strong>General & Knowledge List</strong>
                                </div>
                                <div class="col-md-6 text-right">
                                    <a href="{{ route('general-knowledges.create') }}" class="btn btn-primary">Add General & Knowledge</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($generalKnowledges as $generalKnowledge)
                                        <tr class="{{ $generalKnowledge->status == 0 ? 'table-danger' : '' }}">
                                            <td>{{ $loop->iteration + ($generalKnowledges->currentPage() - 1) * $generalKnowledge->perPage() }}
                                            </td>
                                            <td>{{ $generalKnowledge->type }}<span
                                                    class="badge badge-secondary">{{ $generalKnowledge->genralKnowledges_count }}</span></td>
                                            ...
                                            <td>
                                                <form action="{{ route('general-knowledges.destroy', ['general_knowledge' => $generalKnowledge->id]) }}"
                                                    method="POST">
                                                    @method('DELETE')
                                                    @csrf
