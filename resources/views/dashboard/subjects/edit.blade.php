                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('subjects.update', $subject->id) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <input class="form-control" type="text" minlength="3" maxlength="50" placeholder="Subject Name" name="name" required autofocus value="{{ $subject->name }}" />
                            </div>
                            <div class="form-group row">
                                <label>Order</label>
                                <input class="form-control" type="text" minlength="1" maxlength="8" placeholder="Order" name="order" value="{{ $subject->order }}" />
                            </div>
                            <div class="form-group row">
