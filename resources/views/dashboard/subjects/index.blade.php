                        ...
                        <table class="table table-responsive-sm table-bordered table-striped table-sm mt-2">
                            ...
                            <tbody>
                                ...
                                <tr class="{{ $subject->status == 0 ? 'table-danger' : '' }}">
                                    ...
                                    <td>
                                        <a href="{{ route('subjects.downloadPDF', ['id' => $subject->id]) }}" class="btn btn-info">Download PDF</a>
                                        <a href="{{ route('subjects.downloadHTML', ['id' => $subject->id]) }}" class="btn btn-info">Download HTML</a>
                                    </td>
                                    <td>
