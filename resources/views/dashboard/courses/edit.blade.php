                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('courses.update', $course->id) }}">
                            ...
                            <!-- <div class="form-group row">
                                <label>status</label>
                                <input class="form-control" type="text" placeholder="Roll Number" name="roll_number" required value="{{ $course->status }}" />
                            </div> -->
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 col-form-label">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" id="deactive" type="radio" value="0" name="status" {{$course->status==0 ? 'checked' : ''}}>
